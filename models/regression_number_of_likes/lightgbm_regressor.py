...
class LightGBMRegressorModel:
    def __init__(self, config_path, config_section='lightgbm_reg_one', logger=None):
        """
    ...
    def __preprocess_data(self, df):
        ...
        """
        self.logger.debug("reparing data for LightGBM.")
        X = df[self.features]
        y = df[self.target]
    ...
    def load(self, model_path):
        ...
        Parameters:
            model_path (str): Path to the model fil
        """
